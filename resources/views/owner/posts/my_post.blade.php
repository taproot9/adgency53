        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                @if(Auth::user()->role_id == 3)
                    ...
                    <li class="active"><a style="font-size: smaller" href="{{url('/owner/my_post', Auth::user()->id )}}">Available Advertising Media</a></li>
        ...
        @endif
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    ...
                    {!! Form::open(['method'=>'get', 'url'=>'/owner/ad_spaces/owner_billboard_search', 'class'=>'navbar-form navbar-left', 'role'=>'search']) !!}
