        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                @if(Auth::user()->role_id == 2)
                    ...
                    <li class="active"><a href="{{url('/client/show_my_all_rent')}}">My Rental</a></li>
    ...
    <div class="container" style="padding-top: 70px; padding-bottom: 70px">
        ...
        {{--<div class="row">--}}
            ...
            {{--<div class="col-sm-5">--}}
                ...
                {{--{!! Form::open(['method'=>'get', 'url'=>'/client/show_my_all_rent/adspace_search', 'class'=>'navbar-form navbar-left', 'role'=>'search']) !!}--}}
