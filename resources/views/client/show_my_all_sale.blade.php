        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                @if(Auth::user()->role_id == 2)
                    ...
                    <li class="active"><a href="{{url('/client/show_my_all_sale')}}">My Sales</a></li>
                ...
                @foreach($ad->ad_spaces as $ad_spaces)
                    <div class="col-sm-4">
                        <div class="single-blog">
                            ...
                            {{--<a href="{{url('/client/edit_my_sale_post',[$ad_space->id])}}" class="btn btn-primary">Edit</a>--}}
                        </div>
