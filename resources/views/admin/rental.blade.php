...
<head>
    ...
    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>Adgency Admin Rental</title>
                        ...
                        <div class="box-content">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                @foreach($ad_spaces as $ad_space)
                                    @foreach($ad_space->rents as $space)

                                       <?php $ads_id = $space->pivot->adspace_id ?>
                                       <?php $rent_id = $space->pivot->rent_id ?>
                                       <?php $ads = App\Adspace::findOrFail($ads_id) ?>
                                       <?php $rents = App\Rent::findOrFail($rent_id) ?>
                                       <?php $user = App\User::findOrFail($rents->client_id) ?>
