...
<head>
    ...
    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>Adgency Admin Profile</title>
            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>{{Auth::guard('admin')->user()->name}}</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <div class="row">
                            <div class="col-md-3 col-lg-3 pull-left" align="center">
                            ...
                            {{--<!--src="{{$user->photo ? $user->photo->file : 'http://placehold.it/400x400'}}" alt="">-->--}}
                                <img height="200px" width="200px" class="img-responsive img-rounded"
                                     src="{{Auth::guard('admin')->user()->photo_name}}" style="padding: 30px" alt="">
                            </div>
                            <div class=" col-md-9 col-lg-9 pull-left">
                                <table class="table table-user-information" style="margin-top: 30px">
                                    <tbody>
                                    <tr>
                                        <td><b>Email</b></td>
                            ...
                            {{--<!--<a href="{{action('AdminEditProfileController@edit', [$user->id])}}" class="btn btn-primary">Edit Profile</a>-->--}}
                                <a href="{{action('AdminController@editProfile', Auth::guard('admin')->user()->id)}}" class="btn btn-primary">Edit Profile</a>
                            </div>
                        </div>
