...
<head>
    ...
    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>Adgency Admin Edit Profile</title>
            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <div class="box-content">
                        ...
                        <div class="row">
                            <div class="control-group pull-left col-md-4">
                                ...
                                <img style="padding: 50px" height="150px" width="150px" id ="showimages" class="img-responsive img-rounded" src="{{$user->photo_name ? $user->photo_name : 'http://placehold.it/400x400'}}" alt="">

                            </div>
                            <div class="control-group pull-left col-md-8" style="padding: 30px;">
                                {!! Form::model($user,['method'=>'PATCH', 'action'=>['AdminController@update_profile', $user->id],'files' => true],['class'=>'form-horizontal']) !!}

                                    {{csrf_field()}}

                                    {{--admin image--}}
                                    <div class="control-group">
                                        {!! Form::label('photo_name', 'Admin Photo', ['class'=>'control-label']) !!}
                                        <div class="controls">
