...
<head>
    ...
    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>Adgency Admin Adspace</title>
                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                @foreach($ad_spaces as $ad_space)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$ad_space->posted_by}}</td>

                                        <td class="center">{{$ad_space->advertising_type}}</td>

                                        <td class="center">{{$ad_space->size}}</td>

                                        <td class="center">{{$ad_space->location}}</td>

                                        <td class="center">{{$ad_space->price}}</td>
