...
<head>
    ...
    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>Adgency Admin Reserve</title>
        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{url('admin/all_adspace')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Adspace</span></a></li>
                ...
                <div class="row-fluid sortable">
                    <div class="box span12">
                        <div class="box-header" data-original-title>
                            <h2><i class="halflings-icon white user"></i><span class="break"></span>All Adspace</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                @foreach($ad_spaces as $adspace)
                                    @foreach($adspace->reservations as $space)

                                        <?php $ads_id = $space->pivot->adspace_id?>
                                        <?php $reserve_id = $space->pivot->reservation_id?>
                                        <?php $ads = App\Adspace::findOrFail($ads_id)?>
                                        <?php $reserve = App\Reservation::findOrFail($reserve_id)?>
                                        <?php $user = App\User::findOrFail($reserve->client_id)?>

                                        <tr>

                                            <td class="center">{{$ads->posted_by}}</td>

                                            <td class="center">{{$user->first_name}}</td>

                                            <td class="center">{{$reserve->reserve_date}}</td>

                                            <td class="center">{{$reserve->reserve_until}}</td>

                                            <td class="center">{{$ads->advertising_type}}</td>

                                            <td class="center">{{$ads->size}}</td>

                                            <td class="center">{{$ads->location}}</td>

                                            <td class="center">{{$ads->price}}</td>

                                            {{--<td class="center">--}}

                                            {{--@if($ad_space->status == 1)--}}
